    ...
    const loadProviderDetailsData = async (
      ...
      try {
        ...
        if (data.data && data.data.length > 0) {
          ...
          // Also store the corresponding ID and name for consistency
          // Create a mapping between service type strings and their IDs
          const serviceTypeMapping = {
            "Salon Services": { id: 1, name: "Salon Services" },
            "Home Services": { id: 2, name: "Home Services" }
          };
          
          const selectedType = serviceTypeMapping[serviceType as keyof typeof serviceTypeMapping];
          if (selectedType) {
