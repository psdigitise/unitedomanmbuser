...
export const Header = () => {
  ...
  const navLinkClass = ({ isActive }: { isActive: boolean }) =>
    `pb-1 transition-all ${isActive
      ? "text-mindfulBlack font-semibold border-b-2 border-[#b38b4d]"
      : "text-mindfulBlack font-medium hover:text-[#b38b4d]"
    }`;
        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden lg:flex flex-1 justify-center">
            <ul className="flex items-center space-x-8">
              ...
              <li>
                <NavLink
                  to="/Overview?provider_id=420&branch_id=165"
                  className={navLinkClass}>
                  Pricing
                </NavLink >
              </li>
          ...
          <div className="flex items-center space-x-4 lg:space-x-6">
            <button
              ...
              className="hidden lg:block text-[#6b7280] font-medium hover:text-[#1a233a]">
              Log in
            </button>
