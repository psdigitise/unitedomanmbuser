...
// import { CiStar } from "react-icons/ci";
import { ReviewCard } from "./Review/ReviewCard";
import { fetchReviews } from "../../../api/ApiConfig";
import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import * as zod from "zod";
// import { TiRefresh, TiStar } from "react-icons/ti";
...
return (
  <div>
    ...
    <div>
      <h5 className="text-lg text-mindfulBlack font-semibold mb-2">
        {/* Write a review */}Reviews List
      </h5>
    </div>

    {/* ======= REVIEW FORM COMMENTED OUT BELOW ======= */}
    {/*
    <div className="mb-3">
      <div className="flex items-center">
        {[...Array(5)].map((_, index) => (
    ...
    <div className="border-b-[1px] border-mindfulLightGrey pb-8 mb-10">
      <form onSubmit={handleSubmit(onSubmit)} className="review-form">
        ...
        <div>
          <button
            className={`rounded-[4px] text-lg text-mindfulWhite px-4 py-1.5 ${buttonState.isSubmitted ? "bg-green-500" : "bg-main"}`}
            disabled={loading}
          >
    ...
    */}
    {/* ======= REVIEW FORM COMMENTED OUT ABOVE ======= */}
