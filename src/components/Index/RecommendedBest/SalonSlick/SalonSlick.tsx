...
// import ashtamudi from "../../../../assets/images/ashtamudi.png";
// import vurve from "../../../../assets/images/vurve.png";
// import headFaceUnisex from "../../../../assets/images/headFaceUnisex.png";
// import mydora from "../../../../assets/images/mydora.png";
// import beautyCare from "../../../../assets/images/916BeautyCare.png";
...
export const SalonSlick = () => {
  ...
  useEffect(() => {
    const loadServicesData = async () => {
      ...
      if (latitude && longitude) {
        ...
        try {
          setLoading(true);
          const data = await fetchServiceProviders1(latitude, longitude, 1);
          // const data = await fetchServiceProviders1(8.521837, 76.961996, 1);
  ...
  //     const loadServicesData = async () => {
  //       try {
  //         const data = await fetchServiceProviders(1, "Trichy", "10", 1);

  //         // Log the full response to inspect its structure
  //         console.log("API response:", data);

  //         // Check if data contains an array at a specific key
  //         if (Array.isArray(data)) {
  //           setSalons(data); // Directly set the fetched data if it's an array
  //         } else if (Array.isArray(data.salons)) {
  //           setSalons(data.salons); // Adjust if the array is inside a property like 'salons'
  //         } else {
